#ifndef MYDOMLSPARSER_H
#define MYDOMLSPARSER_H
...
inline void dom_view_doc(const DOMDocument* doc)
{
    ...
    theOutputDesc->setEncoding(toXMLCh("UTF-8")); // Adding utf encoding
...
/*
 * public final class DOMImplementationResgistry
 *
 * Since : DOM Level 3
 * This provides an application with an implementation-independent starting point.
 * DOM implementation may modify this class to meet new security standsrds or to
 * provide *additional* fallback for the list of DOMImplementationSources.
 *
 * DOMLSParser:
...
inline int func_domls_parse(char* myURI)
{
    ...
    // optionally you can set some feature on this builder
