...
#include "Order.pb.h" // system generate header no change
 ...
 *
 * The Message interface defines methods that let you check , manipulate,
 * read , or write the entire message , including parsing from and serializing
 * to binary strings.
 */
...
int main(int argc , char* argv[])
{
   ...
   myItem1->set_desc("Hot Caffe Dark Roast");
   myItem1->set_qty(2);
