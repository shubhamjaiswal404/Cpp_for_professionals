...
{
    numSeq++;
    std::cout << numSeq << "\t -> on_object_end() \t: size : "<< size
              << std::endl;
    return true;
}
...
{
    numSeq++;
    std::cout << numSeq <<" \t -> on_array_end() \t: size : "<< size
              << std::endl;
    return true;
}
...
{
    numSeq++;
    std::cout << numSeq << "\t -> on_key_part() \t: "<< std::endl;
    return true;
}
...
{
    numSeq++;
    std::cout << numSeq << "\t -> on_key() \t\t: " << str << " -> size : "<< size
              << std::endl;
    return true;
}
...
bool MyParserHandler::on_null( error_code& ec)
{
    numSeq++;
...
{
    numSeq++;
    std::cout << numSeq << "\t -> on_comment_part() \t: " << str
              << std::endl;
    return true;
}
...
{
    numSeq++;
    std::cout << numSeq << "\t -> on_comment() \t: " << str
              << std::endl;
    return true;
}
