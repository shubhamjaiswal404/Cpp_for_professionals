...
/*
 * BASIC_PARSER
 * A SAX style parser implementation which converts a seralized JSON into a
 * series of member function call to a user provided handler . This allows
...
int main(int argc, char* argv[])
{
    if(argc != 2)
    {
        std::cerr << "Usage : json_parser <filename> " << std::endl;
        return EXIT_FAILURE;
    }
...
//  error_code ec;
    ...
    {
        std::cerr << "File : " << argv[1] << " <- Validation Not Success \n";
    }
